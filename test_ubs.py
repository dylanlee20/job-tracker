...
def test_ubs():
    ...
    try:
        ...
        html_file = 'data/debug/ubs_initial.html'
        ...
        if found_containers:
            ...
            for i in range(min(3, len(elements))):
                ...
                # 尝试找标题
                for ts in ['h3', 'h2', 'h4', 'a', '[class*="title"]', '[class*="Title"]', 'span[class*="jobTitle"]']:
                    try:
                ...
                for ls in ['.location', '[class*="location"]', '[class*="Location"]', 'span', 'p']:
                    try:
                        ...
                        if loc_text and any(kw in loc_text for kw in ['New York', 'Chicago', 'Hong Kong', 'San Francisco']):
        ...
        # 保存滚动后的HTML
        html_file2 = 'data/debug/ubs_after_scroll.html'
