...
def test_jpmorgan():
    ...
    try:
        ...
        html_file = 'data/debug/jpmorgan_initial.html'
        ...
        if found_containers:
            ...
            for i in range(min(3, len(elements))):
                ...
                # 尝试找标题
                for ts in ['h3', 'h2', 'h4', 'a', '[class*="title"]', '[class*="Title"]']:
                    try:
                ...
                for ls in ['.location', '[class*="location"]', '[class*="Location"]', 'span', 'p']:
                    try:
                        ...
                        if loc_text and any(kw in loc_text for kw in ['United States', 'USA', 'New York', 'Chicago']):
        ...
        # 保存滚动后的HTML
        html_file2 = 'data/debug/jpmorgan_after_scroll.html'
